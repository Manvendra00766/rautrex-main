  ...
  return (
    <div className="w-full bg-[#EDE8DC] border-b border-[#D4CEC4] text-[#1A1714] py-2.5 px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs font-medium z-[1000] relative">
      <div className="flex items-center gap-2.5">
        <span className="bg-[#8B6F47] text-[#FAF7F2] px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider select-none shrink-0">
          SANDBOX
        </span>
        <span className="text-left font-sans text-[11px]">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <button
          ...
          className="text-[#8B6F47] hover:underline flex items-center gap-1 font-bold uppercase tracking-wider text-[10px]"
        >
          Take the tour →
        </button>
        <button
          onClick={exitSandbox}
          className="bg-[#8B6F47] hover:bg-[#8B6F47]/90 text-[#FAF7F2] px-3 py-1.5 rounded-[4px] font-bold uppercase tracking-widest text-[9px] transition-all hover:scale-[1.02] active:scale-[0.98] border-none"
        >
          Exit Sandbox
        </button>
        <button
