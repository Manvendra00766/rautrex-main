    ...
    <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full pb-12">
      ...
      <div className="flex justify-between items-center">
         ...
         <div className="flex items-center gap-2">
            ...
            <Button onClick={runAnalysis} loading={loading} className="bg-accent hover:bg-accent/90 text-text-primary gap-2 font-bold">
      ...
      <Tabs value={mode} onValueChange={setMode} className="w-full">
         <TabsList className="bg-card border border-border p-1 h-12 w-full grid grid-cols-4 rounded-xl">
            ...
            <TabsTrigger value="strategy" className="gap-2 font-bold text-xs uppercase"><Layers size={14} /> Strategy P&L</TabsTrigger>
        ...
        {loading ? (
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-5 gap-4 h-24">
              {[1,2,3,4,5].map(i => <CardSurface key={i} className="animate-pulse bg-muted/50" />)}
            </div>
          ...
          <div className="flex flex-col gap-8">
             ...
             <CardSurface className="p-6 h-[400px]">
                <SectionHeader 
                    title="Spot Price Sensitivity (Greeks Curve)" 
